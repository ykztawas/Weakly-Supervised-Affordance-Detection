#ifndef CAFFE_SIGMOID_CROSS_ENTROPY_LOSS_IOU_LAYER_HPP_
#define CAFFE_SIGMOID_CROSS_ENTROPY_LOSS_IOU_LAYER_HPP_
...
class SigmoidCrossEntropyLossIoULayer : public LossLayer<Dtype> {
 public:
  explicit SigmoidCrossEntropyLossIoULayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "SigmoidCrossEntropyLossIoU"; }

 protected:
  /// @copydoc SigmoidCrossEntropyLossIoULayer
